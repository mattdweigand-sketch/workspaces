...
- Kit owns interpretation, judgment, exception reasoning, decision prep, communication framing, and memory.
...
- Kit owns interpretation of messy inputs before the record is clean.
...
- Kit owns source interpretation: authority, support, conflicts, gaps, and questions.
...
- Kit owns decision framing, tradeoffs, assumptions, risks, precedent, and conditions.
...
- Kit owns interpreting the exception, applying judgment, drafting options, and preparing handoff.
...
- Kit owns narrative, tone, likely questions, response posture, and review packet.
...
- Kit owns interpretation, causal analysis, validation, pattern capture, and reuse.
...
Update the project-doc section so it says Kit has six architecture families and keeps the platform boundary explicit.
...
Those belong to platforms. Kit exists above them.
