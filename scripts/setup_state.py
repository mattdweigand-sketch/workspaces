#!/usr/bin/env python3
"""Small setup state helper for Workspaces."""
...
def is_bootstrap_agents():
    ...
    return "# Workspaces" in text and "What this project is" in text and "Run setup" in text
...
def build_parser():
    parser = argparse.ArgumentParser(description="Workspaces setup state helper")
